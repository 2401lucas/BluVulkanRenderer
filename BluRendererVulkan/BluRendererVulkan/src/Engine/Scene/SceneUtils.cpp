...
SceneDependancies SceneUtils::getBuildDependencies()
{
    //TODO: LOAD SHADERS FROM SCENES
	SceneDependancies sceneUtils{};
    ...
    sceneUtils.textures.push_back(TextureInfo("textures/blue", ".png", textureType::DIFFSPEC));
    //Emerald
