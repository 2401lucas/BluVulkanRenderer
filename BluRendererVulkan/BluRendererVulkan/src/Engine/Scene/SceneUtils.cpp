...
BuildDependancies SceneUtils::getBuildDependencies()
{
    ...
    sceneUtils.textures.push_back(TextureInfo("textures/blue.jpg"));
    sceneUtils.textures.push_back(TextureInfo("textures/viking_room.png"));
    sceneUtils.textures.push_back(TextureInfo("textures/temp.png"));
    //Emerald
